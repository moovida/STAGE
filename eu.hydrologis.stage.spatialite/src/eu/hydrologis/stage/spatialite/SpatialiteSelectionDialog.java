...
public class SpatialiteSelectionDialog extends Dialog {

    private static final String FILTER = "Filter";
    private static final String SELECT_FILE = "Select database";
    ...
    public SpatialiteSelectionDialog( Shell parent, File parentFile ) {
     ...
     */
    public SpatialiteSelectionDialog( Shell parent, int style, File parentFile ) {
        super(parent, style);
        this.parent = parent;
        ...
        shell.addShellListener(new ShellAdapter(){
            ...
            public void shellClosed( ShellEvent event ) {
                if (returnCode == SWT.CANCEL) {
                    SpatialiteSelectionDialog.this.selectedFile = null;
                }
            }
        });
        ...
        fileFolderViewer.setLabelProvider(new LabelProvider(){
            ...
            public Image getImage( Object element ) {
                if (element instanceof File) {
                    File file = (File) element;
                    if (!file.isDirectory()) {
                        return ImageCache.getInstance().getImage(getDisplay(), ImageCache.DATABASE);
                    } else {
        ...
        fileFolderViewer.addSelectionChangedListener(new ISelectionChangedListener(){
            ...
            public void selectionChanged( SelectionChangedEvent event ) {
                ...
                if (selectedItem instanceof File) {
                    ...
                    if (isSpatialiteDb(selectedFile)) {
                        enableOk = true;
                    }
                }
                if (okButton != null) {
    ...
    private Button createButton( Composite parent, String text, final int buttonId ) {
        ...
        result.addSelectionListener(new SelectionAdapter(){
            ...
            public void widgetSelected( SelectionEvent event ) {
                SpatialiteSelectionDialog.this.returnCode = buttonId;
                shell.close();
            }
        });
        return result;
    ...
    private boolean isSpatialiteDb( File file ) {
        return file.getName().endsWith("sqlite");
    }
