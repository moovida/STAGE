...
public class ScriptHandlerOms {
	 ...
	 * @throws Exception
	 */
	public String genereateScript(Shell shell, ModuleGui moduleGui)
			throws Exception {
		...
		for (ModuleGuiElement outElement : modulesOutputGuiList) {
			...
			FieldData fieldData = outElement.getFieldData();
			connectOutputModules(mainModuleDescription, fieldData,
					connectionsSb);
		}
	...
	public void runModule(final String scriptId, String script) {
		// FIXME check if this is even used now
//		JConsoleOutputConsole outputConsole = new JConsoleOutputConsole(
//				scriptId);
...
//		// open console
//		IConsoleManager manager = org.eclipse.ui.console.ConsolePlugin
...
//
//			});
//			String loggerLevelGui = OmsBoxPlugin.getDefault()
//					.retrieveSavedLogLevel();
//			String ramLevel = String.valueOf(OmsBoxPlugin.getDefault()
//					.retrieveSavedHeap());
//			String encoding = OmsBoxPlugin.getDefault().retrieveSavedEncoding();
//
