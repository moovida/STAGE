...
public class JavaEditor extends TextEditor {
            ...
            if (fileTransfer.isSupportedType(event.currentDataType)) {
                ...
                if (files.length > 0) {
                    ...
                    if (file.exists()) {
                        ...
                        JConsoleEditorPlugin.getDefault().setLastOpenFolder(file.getParentFile().getAbsolutePath());
                    }
                }
            }
    ...
    private void startScript() {
        ...
        String dateTimeString = OmsBoxConstants.dateTimeFormatterYYYYMMDDHHMMSS.format(new Date());
        ...
        try {
            ...
            Process process = executor.exec(text, internalStream, errorStream, loggerLevelGui, ramLevel, encoding);
