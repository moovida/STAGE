 ...
 */
public class JConsoleEditorPlugin extends AbstractUIPlugin {
    ...
    // The shared instance
    private static JConsoleEditorPlugin plugin;

    /**
     * The constructor
     */
    public JConsoleEditorPlugin() {
    }
     ...
     */
    public static JConsoleEditorPlugin getDefault() {
        return plugin;
    }
    ...
    public TreeMap<String, List<ModuleDescription>> gatherModules() {
        // TODO chance if necessary
        TreeMap<String, List<ModuleDescription>> availableModules = OmsModulesManager.getInstance().browseModules(false);
        return availableModules;
    }

    public String[] getModulesFieldsNames() {
        // TODO cache if necessary
        TreeMap<String, List<ModuleDescription>> availableModules = gatherModules();
