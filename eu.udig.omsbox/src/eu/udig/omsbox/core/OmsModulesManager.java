...
public class OmsModulesManager {
    ...
    public List<String> getModulesJars( boolean onlyModules ) {
         ...
         * load modules
         */
        File modulesFolder = OmsBoxPlugin.getModulesFolders();
        if (modulesFolder != null) {
            OmsBoxPlugin.log("Searching module libraries in: " + modulesFolder.getAbsolutePath());
         ...
         */
        if (!onlyModules) {
            File libsFolder = OmsBoxPlugin.getLibsFolders();
            if (libsFolder != null) {
                OmsBoxPlugin.log("Searching libs in: " + libsFolder.getAbsolutePath());
        ...
        for( URL url : urlList ) {
            ...
            for( Entry<String, Properties> serviceEntry : servicesEntrySets ) {
                ...
                for( Entry<Object, Object> entry : entrySet ) {
                    ...
                    // Avoid loading of oms modules, load only the file based modules
