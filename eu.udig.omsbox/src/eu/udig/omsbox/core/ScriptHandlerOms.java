...
public class ScriptHandlerOms {
    ...
    public void runModule( final String scriptId, String script ) {
        ...
        try {
            ...
            Process process = executor.exec(script, internalStream, errorStream, loggerLevelGui, ramLevel, encoding);
    ...
    // && fieldData.guiHints.contains(OmsBoxConstants.FILEOUT_UI_HINT) && fieldData.fieldValue !=
    // null
