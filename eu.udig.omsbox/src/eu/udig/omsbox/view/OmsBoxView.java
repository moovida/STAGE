...
public class OmsBoxView extends ViewPart {
    ...
    private void addQuickSettings( Composite modulesListComposite ) {
        ...
        String savedEncoding = OmsBoxPlugin.getDefault().retrieveSavedEncoding();
        ...
        encodingCombo.addSelectionListener(new SelectionAdapter(){
            public void widgetSelected( SelectionEvent e ) {
                ...
                OmsBoxPlugin.getDefault().saveEncoding(item);
            }
        });
     ...
     */
    public void relayout() throws InvocationTargetException, InterruptedException {
