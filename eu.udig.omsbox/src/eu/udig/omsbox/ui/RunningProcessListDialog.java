...
public class RunningProcessListDialog {
    ...
    public void open( final Shell parentShell, final int selectionType ) {
        ...
        dialog = new Dialog(parentShell){
            ...
            protected void buttonPressed( int buttonId ) {
                if (buttonId == OK) {
                    if (currentSelectedProcessId == null) {
                        MessageDialog.openInformation(parentShell, "Process List", "No process selected to terminate.");
                    } else {
                        OmsBoxPlugin.getDefault().killProcess(currentSelectedProcessId);
                        currentSelectedProcessId = null;
                    }
                }
